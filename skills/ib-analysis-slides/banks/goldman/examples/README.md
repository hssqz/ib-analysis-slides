...
|---|---|---|
| [analysis](analysis/index.html) A1 | Product roles, customer revenue, qualified mechanism | Capability/product breadth and relationships |
| analysis A2 | Historical totals, disclosed endpoint components, software inside services | Selective stacking and subset |
| analysis A3 | Cumulative fundraising, peer scale with full linear baseline | Cumulative comparison |
| analysis A4 | Cash-flow-matched PME vs net IRR, actual/floor/qualitative target | Shared numeric scale and target qualifiers |
| [financial](financial/index.html) F1 | Annual/quarterly results, nested costs, negative profit | Financial overview and profit chain |
| financial F2 | Selected balance sheet, ratios and unexplained equity residual | Multi-table scope and reconciliation |
| financial F3 | AUM bridge, independent classifications, fee-earning subset | Stock vs flow and multiple views |
| [relationships/analysis](relationships/analysis.html) B2 | Five product sectors around clients; qualified mechanism | Qualitative relationship ring |
